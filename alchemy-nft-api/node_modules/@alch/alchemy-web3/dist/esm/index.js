...
export function createAlchemyWeb3(alchemyUrl, config) {
    ...
    var _a = makeAlchemyContext(alchemyUrl, fullConfig), provider = _a.provider, jsonRpcSenders = _a.jsonRpcSenders, restSender = _a.restSender, setWriteProvider = _a.setWriteProvider;
